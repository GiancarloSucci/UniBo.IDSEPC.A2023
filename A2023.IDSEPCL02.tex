...
\newcommand{\fileuri}{https://raw.githubusercontent.com/GiancarloSucci/UniBo.IDSEPC.A2023/main/A2022.IDSEPCLaTeX/}
...
\begin{center}
  \includegraphics[width=0.8\linewidth]{UniBo.IDSEPC.A2023.LavoroCondiviso/vc_paradigms}
\\
\small
...
\begin{frame}{\centerline{\git? Perch\'{e} ``\git''?}}
  \begin{columns}
    \begin{column}{5cm}
      ...
      \begin{figure}
        \centering
        \includegraphics[width=4cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/Linus_Torval';.ds}
      \end{figure}
    \end{column}
    \begin{column}{7cm}
      \begin{figure}
...
\begin{frame}{\centerline{ \git ~ -- Singolo+Locale -- Init}}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-init}
  \end{figure}
...
\begin{frame}{\centerline{ \git ~ -- Singolo+Locale -- Il flusso dei dati}}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=5.5cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/staging}
  \end{figure}
  \begin{center}
...
\begin{frame}{\centerline{ \git ~ -- Singolo+Locale -- Add}}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=7cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-add}
  \end{figure}
\end{frame}
...
\begin{frame}{\centerline{ \git ~ -- Singolo+Locale -- Commit (1/2)}}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-commit}
  \end{figure}
\end{frame}
...
\begin{frame}{\centerline{ \git ~ -- Singolo+Locale -- Commit (2/2)}}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-commit-filename}
  \end{figure}
  \begin{center}
...
\begin{frame}{\centerline{ \git ~ -- Singolo+Locale -- Diff }}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-diff}
  \end{figure}
\end{frame}
...
\begin{frame}{\centerline{ \git ~ -- Singolo+Locale -- Logs (1/2)}}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-log}
  \end{figure}
\end{frame}
...
\begin{frame}{\centerline{ \git ~ -- Singolo+Locale -- Logs (2/2) }}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9.4cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/gitk_cropped}
  \end{figure}
\end{frame}
...
\begin{frame}{\centerline{\git ~ -- Team+Remoto/Condiviso (2/3)}}
  \begin{figure}
    \centering
    \includegraphics[width=10cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/workflow-a}
  \end{figure}
\end{frame}
...
\begin{frame}{\centerline{\git ~ -- Team+Remoto/Condiviso (3/3)}}
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-remote}
  \end{figure}  
\end{frame}
...
\begin{frame}{\centerline{\git ~ -- Team+Remoto/Condiviso  -- Passi}}
  ...
  \begin{figure}
    \begin{center}
      \includegraphics<1>[width=9cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-remote-before-clone}
      \includegraphics<2>[width=9cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-remote-clone2}
    \end{center}
  \end{figure}
...
\begin{frame}{\centerline{\git ~ -- Team+Remoto/Condiviso  -- Fetch}}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9.5cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-remote-fetch}
  \end{figure}
\end{frame}
...
\begin{frame}{\centerline{\git ~ -- Team+Remoto/Condiviso  -- Merge}}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9.5cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-remote-merge}
  \end{figure}
  \begin{center}
...
\begin{frame}{\centerline{\git ~ -- Team+Remoto/Condiviso  -- Push}}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9.5cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-remote-push}
  \end{figure}
\end{frame}
...
\begin{frame}{\centerline{Dinamica del branching -- partenza}}
  \begin{columns}
    \begin{column}{0.6\linewidth}
      \begin{center}
        \includegraphics[width=6cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/18333fig0310-tn}
      \end{center}
    \end{column}
  ...
  \vspace{1em}
  \begin{center}
    \includegraphics[width=9cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/local-remote-clone}
  \end{center}
\end{frame}
...
\begin{frame}{\centerline{Dinamica del branching -- evoluzione (1/3)}}
  \begin{columns}
    \begin{column}{0.6\linewidth}
      \begin{center}
        \includegraphics[width=4cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/18333fig0311-tn}
      \end{center}
    \end{column}
  ...
  \end{columns}
  \begin{center}
    \includegraphics[width=8cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/git-branch}
  \end{center}
\end{frame}
...
\begin{frame}{\centerline{Dinamica del branching -- nuovo commit}}
  \begin{columns}
    \begin{column}{0.6\linewidth}
      \begin{center}
        \includegraphics[width=6cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/18333fig0312-tn}
      \end{center}
    \end{column}
    \begin{column}{0.4\linewidth}
      \begin{center}
  ...
  \end{columns}
  \begin{center}
    \includegraphics[width=7cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/git-checkout}
  \end{center}
\end{frame}
...
\begin{frame}{\centerline{Dinamica del branching -- fix (2/2)}}
  \begin{columns}
    \begin{column}{0.6\linewidth}
      \begin{center}
        \includegraphics[width=5cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/18333fig0313-tn}
      \end{center}
    \end{column}
    \begin{column}{0.45\linewidth}
      \begin{center}
  ...
  \end{columns}
  \begin{center}
    \includegraphics[width=7cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/git-checkout2}
  \end{center}
\end{frame}
...
\begin{frame}{\centerline{Spiegazione dettagliata}}
  \includegraphics<1>[width=11cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/pull-request-0}
  \includegraphics<2>[width=11cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/pull-request3-1}
  \includegraphics<3>[width=11cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/pull-request3-2}
  \includegraphics<4>[width=11cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/pull-request3-3}
  \includegraphics<5>[width=11cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/pull-request3-4}
  \includegraphics<6>[width=11cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/pull-request3-5}
  \includegraphics<7>[width=11cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/pull-request-4}
  \includegraphics<8>[width=11cm]{UniBo.IDSEPC.A2023.LavoroCondiviso/pull-request-5}
  \begin{center}
